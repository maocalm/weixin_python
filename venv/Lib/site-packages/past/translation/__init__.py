...
class Py2Fixer(object):
    ...
    def find_module(self, fullname, path=None):
        ...
        if self.kind == imp.PKG_DIRECTORY:
            self.pathname = os.path.join(self.found[1], 'flask_study.py')
    ...
    def load_module(self, fullname):
        ...
        if fullname in sys.modules:
            ...
            if not convert:
                ...
                # cannot perform relative import" for a package's flask_study.py
                ...
                # ispkg = self.pathname.endswith('flask_study.py')
