...
class commentsAnalysis(object):
    def __init__(self, database, movie_name):
        ...
        self.stopwords = pd.read_csv("1893utf8.txt", index_col=False, quoting=3, sep=" ", names=['stopword'],
                                encoding='utf-8')
    ...
    def ratingAnalysis(self, data):
        ...
        print("score-----> describe ",data['score'].describe())  # 对评论分数做描述性统计分析
...
if __name__ == '__main__':
    ...
    dataAnalysis.ratingAnalysis(data)
